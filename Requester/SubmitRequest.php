...
<div class="col-sm-9 col-md-10 mt-5"> <!-- Start Service Request Form 2nd Column -->
 <form class="mx-5" action="" method="POST">
  ...
  <i class="fas fa-chevron-down"></i> <label for="inputRequestInfo"> Service Type [Choose your choice] </label>
  
  <div class="form-check">
  <input class="form-check-input" type="radio" name="requestinfo" id="inputRequestInfo" value="Motorbike" >
  <i class="fas fa-motorcycle"></i>
    Motorbike
  </label>
</div>
<div class="form-check">
  <input class="form-check-input" type="radio" name="requestinfo" id="inputRequestInfo" value="Car" checked>
...
<hr></hr>
  ...
  <div class="form-group">
  <i class="fas fa-pen"></i><label for="inputRequestDescription">Description [ Any issues related to Car/Motorbike. ]</label>
   <input type="text" class="form-control" id="inputRequestDescription" placeholder="Please Mention Here" name="requestdesc">
  </div>
  <div class="form-group">
  <i class="fas fa-user"></i><label for="inputName">Name</label>
   <input type="text" class="form-control" id="inputName" placeholder="Rahul" name="requestername">
  </div>
  <div class="form-row">
   <div class="form-group col-md-6">
   <i class="fas fa-home"></i><label for="inputAddress">    Address Line 1</label>
     <input type="text" class="form-control" id="inputAddress" placeholder="House No. 123" name="requesteradd1">
   </div>
   <div class="form-group col-md-6">
   <i class="fas fa-home"></i><label for="inputAddress2">   Address Line 2</label>
    <input type="text" class="form-control" id="inputAddress2" placeholder="Railway Colony" name="requesteradd2">
   </div>
  </div>
  <div class="form-row">
   <div class="form-group col-md-6">
   <i class="far fa-building"></i><label for="inputCity">City</label>
    <input type="text" class="form-control" id="inputCity" name="requestercity">
   </div>
   <div class="form-group col-md-4">
   <i class="fas fa-map-marker-alt"></i><label for="inputState">State</label>
  ...
  <div class="form-row">
   <div class="form-group col-md-6">
   <i class="fas fa-envelope"></i><label for="inputEmail">Email</label>
    <input type="email" class="form-control" id="inputEmail" name="requesteremail">
   </div>
   <div class="form-group col-md-2">
   <i class="fas fa-phone-square-alt"></i><label for="inputMobile">Mobile</label>
    <input type="text" class="form-control" id="inputMobile" name="requestermobile" onkeypress="isInputNumber(event)">
   </div>
   <div class="form-group col-md-2">
   <i class="far fa-calendar-alt"></i><label for="inputDate">Date</label>
