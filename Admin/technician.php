...
<div class="col-sm-9 col-md-10 mt-5 text-center">
 <p class="bg-dark text-white p-2">List of Servicers</p>
 <?php 
  ...
  if($result->num_rows > 0){
   echo '<table class="table">';
    echo '<thead>';
     echo '<tr>';
      echo '<th scope="col">Servicer ID</th>';
...
?>
  ...
  <div class="float-right"><a href="insertemp.php" class="btn btn-primary"><i class="fas fa-plus-circle"></i></a></div>
 </div> <!-- End Container -->
