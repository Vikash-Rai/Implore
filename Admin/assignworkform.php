...
<div class="col-sm-5 mt-5 jumbotron"> <!-- Start Assigned Work 3rd Column-->
 <form action="" method="POST">
   <h5 class="text-center"><i class="fas fa-briefcase"></i>Assign Work Order Request</h5>
   ...
   <div class="form-group">
     <label for="request_info">Service Type </label>
   ...
   <div class="form-row">
    <div class="form-group col-md-6">
      <label for="assigntech">Assign Servicer</label>
