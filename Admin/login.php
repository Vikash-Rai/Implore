...
<body>
 <div class="mb-3 mt-5 text-center bg-dark text-light" style="font-size: 30px;">
 
  <span>Implore <i class="fas fa-tools"></i></span>
 </div>
 <p class="text-center mt-10" style="font-size:35px;"><i class="fas fa-user-shield"></i>   Admin</p>
